...
public class BillingServiceImpl implements BillingService {
     ...
     *
     * Then persist a new BillingRun (with runTimestamp = now), send each member an email,
    ...
    public List<MemberBillDto> runQuarterlyBilling() {
        ...
        for (Member member : allMembers) {
            ...
            if (totalDue > 0.0) {
                ...
                // (Optional) You could also pass a list of line‐items if you want to detail them.
        ...
        // 8. Return all the MemberBillDto objects
        return results;
    }
}
