        ...
        billingRuns.forEach(run -> {
                ...
                detailDto.setDrinkLogs(
                        ...
                        .map(drinkLog -> {
                                ...
                                if(detailDto.isInvoiced() != true && drinkLog.isBilled() == true){
                                        detailDto.setInvoiced(true);
                                }
                                if(detailDto.isPaid() != true && drinkLog.isPaid() == true){
                                        detailDto.setPaid(true);
                                }
                                detailDto.setTotal(detailDto.getTotal() + drinkLog.getTotal());
